...
const controlRoomScreen = require("./control_room_screen")
const controlRoom = require("./control_room")
const shutdownProgress = require("./shutdown_progress")
...
module.exports = {
  ...
  "actions": [
    ...
    _.assign({description: "Taper \"sudo hqlt\""}, goodAction),
    _.assign({description: "Taper \"fuck\""}, goodAction),
    {
...
function handler(place, action, request, response) {
  ...
  const timer = setInterval(() => {
    ...
    shutdownProgress.description = action.unhref.description.replace(shutdownProgress.countdown.toString(), remaining.toFixed(0))
